...
> **📷 Picture:** Insert a simple diagram explaining EIS or a flower impedance measurement setup.
...
We built FloraFit as an interactive R Shiny application that takes impedance measurements as input, fits different equivalent circuit models, and visualizes the results through Nyquist and Bode plots. Alongside the plots, the application also reports the estimated circuit parameters and fitting statistics, making it easier to compare models and interpret experiments. :contentReference[oaicite:0]{index=0}

One thing I appreciated while working on the application was how modular everything was. Circuit models, optimization routines, plotting, and the user interface were all separated cleanly, making it straightforward to extend the software as new models are developed. :contentReference[oaicite:1]{index=1}

> **📷 Picture:** Screenshot of the FloraFit interface (Figure 5 from the paper).
...
Each model provides a different balance between biological realism and mathematical simplicity, allowing researchers to choose the one that best describes their experimental data. :contentReference[oaicite:2]{index=2}

What I liked most was seeing how electrical engineering concepts could be used to describe living biological systems.

> **📷 Picture:** Figure showing the four equivalent circuit models (Figure 1).
...
To make the fitting more reliable, FloraFit first estimates sensible initial parameters before performing multi-stage nonlinear optimization. This greatly improves convergence while keeping the estimated parameters physically meaningful. :contentReference[oaicite:3]{index=3}
...
> **📷 Picture:** Nyquist plot (Figure 3).

> **📷 Picture:** Bode magnitude and phase plots (Figure 4).
...
Seeing the project evolve from research discussions into a working application—and now into a paper that we are preparing to submit—has been incredibly rewarding. :contentReference[oaicite:4]{index=4}

> **📷 Picture:** Screenshot of the paper's title page or a photo of you working on the manuscript (if you have one).
